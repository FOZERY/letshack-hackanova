  ...
  <div>
    <aside class="sidebar">
      <div class="panel">
        ...
        <div class="user-icon">
          <div class="bg-stone-300 w-full h-full"></div>
        </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <a class="nav-link">
              <svg class="stroke-hover" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <path
                    ...
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M12 6V12L16 14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
              <p>Таймлайн</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link">
              <svg class="stroke-hover" width="24" height="24" viewBox="0 0 24 24" fill="none"
                   xmlns="http://www.w3.org/2000/svg">
                <path d="M12 14L21 9L12 4L3 9L12 14Z" stroke="#7C8DB0"></path>
                <path
                    d="M12.0001 14L18.1601 10.578C18.9706 12.6361 19.2006 14.8772 18.8251 17.057C16.2886 17.3032 13.8973 18.3536 12.0001 20.055C10.1031 18.3538 7.71216 17.3034 5.17608 17.057C4.80028 14.8772 5.03031 12.636 5.84108 10.578L12.0001 14Z"></path>
                <path
            ...
            <a class="nav-link disabled">
              <svg class="fill-hover" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M3.25 3C3.25 2.0335 4.0335 1.25 5 1.25H15.5C15.7126 1.25 15.9152 1.34024 16.0575 1.49828L20.5575 6.49828C20.6814 6.63599 20.75 6.81472 20.75 7V21C20.75 21.9665 19.9665 22.75 19 22.75H5C4.03351 22.75 3.25 21.9665 3.25 21V3ZM5 2.75C4.86193 2.75 4.75 2.86193 4.75 3V21C4.75 21.1381 4.86192 21.25 5 21.25H19C19.1381 21.25 19.25 21.1381 19.25 21V7.2878L15.166 2.75H5Z"></path>
                <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M16.4749 10.9195C16.7955 11.1818 16.8428 11.6543 16.5805 11.9749L12.0805 17.4749C11.9538 17.6298 11.7705 17.7276 11.5713 17.7466C11.3721 17.7656 11.1736 17.7043 11.0199 17.5762L8.01988 15.0762C7.70167 14.811 7.65868 14.3381 7.92385 14.0199C8.18903 13.7017 8.66195 13.6587 8.98016 13.9238L11.3988 15.9394L15.4196 11.0251C15.6818 10.7045 16.1544 10.6572 16.4749 10.9195Z"></path>
                <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M15 1.25C15.4142 1.25 15.75 1.58579 15.75 2V6.25H20C20.4142 6.25 20.75 6.58579 20.75 7C20.75 7.41421 20.4142 7.75 20 7.75H15C14.5858 7.75 14.25 7.41421 14.25 7V2C14.25 1.58579 14.5858 1.25 15 1.25Z"></path>
              </svg>
              <p>Решения</p><span class="nav-link-tooltip body-text-small">Скоро откроется</span>
            </a>
          </li>

          <li class="nav-item">

            <a href="https://xn--80ajqb5afw.xn--80aa3anexr8c.xn--p1acf/personal/about" class="nav-link">
              <svg class="fill-hover" width="24" height="24" viewBox="0 0 24 24" fill="none"
                   xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M11 7H13V9H11V7ZM11 11H13V17H11V11ZM12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z"></path>
              </svg>
              <p>О мероприятии</p>
            </a>
          </li>
...
<style scoped>
/* letshack module */
@import '@/assets/letshack.module.css';
